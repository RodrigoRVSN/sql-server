...
INSERT INTO Raça VALUES
	...
	('Espadachim', 'Bom em cortar', 'Ladino')
...
SELECT MAX(DataNascimento) MaxCreationDate, MIN(DataNascimento) MinCreationDate 
FROM Personagem;
...
/* 6. Criar uma consulta para exibir o Nome daclasse e a soma do valor dos seus poderes. Somente devem ser exibidas as classes cujasoma dos poderes esteja entre 150 e 250. */
...
SELECT
	P.Nome, 
	P.DataNascimento Nascimento,
	R.Nome Raça,
	C.Nome Classe,
	H.Nome Habilidade
FROM Personagem P 
INNER JOIN Raça R ON P.IDRaça = R.IDRaça 
